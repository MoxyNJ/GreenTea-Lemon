...
<img src="source/image-20210119171808543.png" alt="image-20210119171808543" style="zoom:50%;" /> 
...
`var ele = <label> Text element </label> `
...
- 模块：向外提供特定功能的 js 程序：一个模块，就是一个 js 文件
